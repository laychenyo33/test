...
$TPLMSG['ALL'] = "todos";
$TPLMSG['FORM'] = "forma";
$TPLMSG['SUBJECT'] = "Subject";
$TPLMSG['CONTENT'] = "assunto";
$TPLMSG['NAME'] = "nome";
$TPLMSG['JOIN'] = "juntar";
$TPLMSG['INQUIRY'] = "inquérito";
$TPLMSG['INQUIRY_CART'] = "Carrinho inquérito";
$TPLMSG['INQUIRY_PRICE'] = "inquérito";
$TPLMSG['SHOPPING'] = "comprar";
$TPLMSG['SHOPPING_CART'] = "carrinho de compras";
$TPLMSG['STATUS'] = "estado";
$TPLMSG['ADD'] = "adicionar";
$TPLMSG['MODIFY'] = "modificar";
$TPLMSG['SEND'] = "enviar";
$TPLMSG['REPLY'] = "responder";
$TPLMSG['REPLY_YES'] = "<font color='blue'>sim</font>";
$TPLMSG['REPLY_NO'] = "<font color='red'>não</font>";
$TPLMSG['DEL'] = "excluir";
$TPLMSG['CATE'] = "categoria";                                                                  
$TPLMSG['YES'] = "sim";
$TPLMSG['NO'] = "não";
$TPLMSG['DATE_ONLINE'] = "Data on-line";
$TPLMSG['CONTACT'] = "O contato do homem";
$TPLMSG['URL'] = "URL";
$TPLMSG['OK'] = "OK";
$TPLMSG['CANCEL'] = "cancelar";
$TPLMSG['DATE'] = "data";
$TPLMSG['TIME'] = "tempo";
$TPLMSG['CREATEDATE'] = "criado";
$TPLMSG['MODIFYDATE'] = "modificado";
$TPLMSG['STARTDATE'] = "começar";
$TPLMSG['ENDDATE'] = "expirar";
$TPLMSG['TOTAL'] = "total";
$TPLMSG['PAGES'] = "páginas";
$TPLMSG['DELETE_CHECK_STR'] = "Você tem certeza?";
$TPLMSG['TOTAL_RECORDS'] = "total de Registros";
$TPLMSG['TOTAL_PAGES'] = "total de Páginas";
$TPLMSG['AMOUNT'] = "quantidade";
$TPLMSG['DETAIL'] = "detalhe";
$TPLMSG['VIEWS'] = "vista";
$TPLMSG['FILE'] = "arquivo";
$TPLMSG['PUBLISH_ON'] = "não expirados";
$TPLMSG['PUBLISH_OFF'] = "expirado";
$TPLMSG['PAGE_BACK'] = "de volta";
$TPLMSG['EMAIL'] = "E-mail";
$TPLMSG['CLEAN'] = "Clean";
...
//LOGIN
$TPLMSG['LOGIN_ACCOUNT'] = "conta";
$TPLMSG['LOGIN_PASSWORD'] = "senha";
$TPLMSG['LOGIN_SECURITY'] = "código";
$TPLMSG['LOGIN_LANGUAGE'] = "linguagem";
$TPLMSG['LOGIN_NOTICE1'] = "Faça o login ou registre-se para baixar o nosso vídeos.";
$TPLMSG['LOGIN_FORGOT_PASSWORD'] = "Esqueceu sua senha?";
$TPLMSG['LOGIN_REGISTER'] = "Ir para o Registro";
...
//ADMIN
$TPLMSG['ADMIN_VALID_ACCOUNT'] = "Conta válido";
$TPLMSG['ADMIN_ACCOUNT_EXIST'] = "existir";
$TPLMSG['ADMIN_ACCOUNT_NO_USE'] = "não registado";
$TPLMSG['ADMIN_PLEASE_INPUT_ACCOUNT'] = "Por favor, conta de entrada.";
//CONTACT US
$TPLMSG['CONTACT_US'] = "Fale Conosco";
$TPLMSG['CONTACT_US_PRODUCTS'] = "sobre Produtos";
$TPLMSG['CONTACT_ERROR_REPORTING'] = "Comentários de erro";
$TPLMSG['CONTACT_SUGGESTION'] = "sugestão";
$TPLMSG['CONTACT_US_OTHERS'] = "outros";
$TPLMSG['CONTACT_US_MAIL_NOTICE'] = "Congratulamo-nos com o seu valor e feedbacks sobre nossos produtos e serviços. Vamos ser a resposta a sua pergunta instantaneamente.";
$TPLMSG["CONTACT_US_DETAIL"]="detalhe";
$TPLMSG["CONTACT_US_REPLY"]="responder";
$TPLMSG["CONTACT_US_REPLY_CONTENT"]="conteúdo";
$TPLMSG["CONTACT_US_REPLY_TIME"]="respondeu Tempo";
$TPLMSG['CONTACT_US_COMPANY_NAME']="Nome da Empresa";
$TPLMSG['CONTACT_US_TITLE']="título";
$TPLMSG['CONTACT_US_FAX']="fax";
$TPLMSG['CONTACT_US_MOBIL']="telefone móvel";
$TPLMSG['CONTACT_US_SITE']="site";
$TPLMSG['CONTACT_US_COUNTRY']="país";
$TPLMSG['CONTACT_US_CITY']="cidade";
$TPLMSG['CONTACT_US_SUBJECT']="assunto";
...
//EPAPER
$TPLMSG['SUBSCRIBE'] = "subscrever";
$TPLMSG['EPAPER'] = "ePaper";
//MEMBER
$TPLMSG['MEMBER_ZONE']="Acesso de Membros";
$TPLMSG['BIRTHDAY']="aniversário";
$TPLMSG['ZIP']="CEP";
$TPLMSG['CITY']="City";
$TPLMSG['AREA']="Area";
$TPLMSG['SEX']="";
$TPLMSG['MALE']="masculino";
$TPLMSG['FEMALE']="feminino";
$TPLMSG['ADDRESS']="endereço";
$TPLMSG['TEL']="telefone";
$TPLMSG['FAX']="fax";
$TPLMSG['CONTACT_PERSON']="Pessoa de contato";
$TPLMSG['COMPANY_NAME']="Nome da Empresa";
$TPLMSG['CELLPHONE']="celular";
$TPLMSG['COUNTRY']="país";
$TPLMSG['MEMBER_CHECK_ACCOUNT']="Conta válido";
$TPLMSG['MEMBER_CHECK_PASSWORD']="Senha válido";
$TPLMSG['MEMBER_DATA_MOD']="Editar dados básicos";
$TPLMSG['MEMBER_ACCOUNT_NOT_EXISTS']="Account not exists!!";
$TPLMSG['MEMBER_LOGIN']="login";
$TPLMSG["MEMBER_LOGOUT"]="Sair";
$TPLMSG['MEMBER_JOIN']="registrar";
$TPLMSG['MEMBER_CONFIRM_MAIL']="Confirmar E-mail";
$TPLMSG['MEMBER_NAME']="nome";                                                           
$TPLMSG['MEMBER_FNAME']="first name";                                                           
$TPLMSG['MEMBER_LNAME']="last name";                                                           
$TPLMSG['MEMBER_ZONE_DATA']="Os dados do membro";
$TPLMSG['MEMBER_ZONE_ORDER']="Ordens membro";
$TPLMSG['MEMBER_ZONE_INQUIRY']="Consultas membro";
$TPLMSG['MEMBER_ZONE_CONTACTUS']="comentários";
$TPLMSG['MEMBER_ZONE_GREETINGS']="Hi, %s";
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="Aceitar Termo de Serviço";
$TPLMSG['MEMBER_DISCOUNT']="desconto";
...
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="concordo";
...
$TPLMSG["MEMBER_ACCOUNT_EXISTS"] = "Conta de Usuário existiu!";
...
$TPLMSG['PRODUCT_IMG'] = "Imagem do produto";
$TPLMSG['PRODUCT_CATE'] = "categoria";
$TPLMSG['PRODUCT_LIST'] = "Lista de produtos";
$TPLMSG['PRODUCT_SHOW'] = "Apresentar produtos";
$TPLMSG['PRODUCT_NAME'] = "Nome do produto";
$TPLMSG['PRODUCT_NEW'] = "Produtos novos";
$TPLMSG['PRODUCT_HOT'] = "Produtos quentes";
$TPLMSG['PRODUCT_PROMOTION'] = "produtos em promoção";
$TPLMSG['PRODUCT_DESCRIPTION'] = "Descrição do produto";
$TPLMSG['PRODUCT_SPEC'] = "Especificações do produto";
$TPLMSG['PRODUCT_CHARACTER'] = "caráter";
$TPLMSG['PRODUCT_PRICE'] = "preço";
$TPLMSG['PRODUCT_LIST_PRICE'] = "Preço lista";
$TPLMSG['PRODUCT_SPECIAL_PRICE'] = "na venda";
$TPLMSG['PRODUCT_DISCOUNT_PRICE'] = "Preço com desconto";
$TPLMSG['PRODUCT_SERIAL'] = "Serial produto";
$TPLMSG['PRODUCT_COLLECTION'] = "Collect it";
$TPLMSG['PRODUCT_OUT_OF_STOCK'] = "Out of stock.";

// CART
$TPLMSG['CART_ADD'] = "";
$TPLMSG['CART_INQUIRY'] = "Carrinho inquérito";
$TPLMSG['CART_SHOPPING'] = "carrinho de compras";
$TPLMSG['CART_TOTAL'] = "total";
$TPLMSG['CART_SUBTOTAL'] = "subtotal";
$TPLMSG['CART_AMOUNT'] = "quantidade";
$TPLMSG['CART_MODIFY_AMOUNT'] = "modificar Valor";
$TPLMSG['CART_CONTINUE_SHOPPING'] = "continuar";
$TPLMSG['CART_CONTINUE_INQUIRY'] = "continuar";
$TPLMSG['CART_FINISH_SHOPPING'] = "acabamento";
$TPLMSG['CART_FINISH_INQUIRY'] = "acabamento";
$TPLMSG['CART_DELETE_CHECK'] = "Tem certeza que deseja excluir dados?";
...
$TPLMSG['SHIPPING_PRICE'] = "Custos de transporte";

//SERVICE TERM
$TPLMSG["SERVICE_CENTER"] = "centro de serviços";
$TPLMSG["CONTACTUS_TERM"] = "Contate-nos Termo";
$TPLMSG["JOIN_MEMBER_MAIL"] = "Junte-mail Membro de resposta automática";
$TPLMSG["PAYMENT_TERM"] = "prazo de pagamento";
$TPLMSG["PRIVACY_POLICY"] = "Política de Privacidade";
$TPLMSG["SERVICE_TERM"] = "Termos de Serviço";
$TPLMSG["SHIPPING_TERM"] = "prazo de envio";
$TPLMSG["SHOPPING_TERM"] = "prazo de compras";
$TPLMSG["INQUIRY_MAIL"] = "Inquérito Carrinho de e-mail de resposta automática";
...
$TPLMSG["ORDER_NEW"]="novo";
$TPLMSG["ORDER_DEALING"]="lidando";
$TPLMSG["ORDER_PRODUCTS_SEND"]="preparar";
$TPLMSG["ORDER_COMPLETED"]="concluído";
$TPLMSG["ORDER_CANCEL"]="<font color='red'>cancelar</font>";
$TPLMSG["ORDER_REJECT"]="<font color='red'>rejeitar</font>";
$TPLMSG["ORDER_DETAIL"]="detalhe";
$TPLMSG["ORDER_CONTENT"]="conteúdo";
...
//PAYMENT
$TPLMSG["PAYMENT_TYPE"]="Tipo de pagamento";
$TPLMSG["PAYMENT_ATM"]="caixa eletrônico";
$TPLMSG["PAYMENT_CASH_ON_DELIVERY"]="pagamento contra entrega";
$TPLMSG['CHOOSE_PAYMENT_TYPE'] = "choose a type";

//INQUIRY
$TPLMSG["INQUIRY_ID"]="ID inquérito";
$TPLMSG["INQUIRY_DETAIL"]="detalhe";
$TPLMSG["INQUIRY_CONTENT"]="conteúdo";
$TPLMSG["INQUIRY_QUANTITY_UPDATED"]="Quantity updated!";

//DOWNLOAD
$TPLMSG["DOWNLOAD"]="baixar";

//FORGOT PASSWORD
$TPLMSG["FORGOT_PASSWORD"]="Esqueceu a senha";

//EBOOK
$TPLMSG["EBOOK"]="E-catálogo";
$TPLMSG["EBOOK_DOWNLOAD"]="Download";
$TPLMSG["EBOOK_PRINT"] ="Impressão";

//ACTION MESSAGE
$TPLMSG['ACTION_TERM'] = "Apenas um momento!!<BR>Esta página será redirecionada!!";
$TPLMSG['ACTION_TERM_JS'] = "Seus dados tenham sido submetidos!!";
$TPLMSG["ACCOUNT_EXIST"] ="Este é accout existia! Por favor, conta uma nova entrada!";


//ERROR MESSAGE
$TPLMSG['LOGIN_ERROR'] = "Conta ou erro de senha!!";
$TPLMSG['SECURITY_ERROR'] = "Código de erro de segurança!!";
//DATA MESSAGE
$TPLMSG['NO_DATA'] = "vazio!!";
$TPLMSG['NO_CATE'] = "Sem Categoria";
//JS MESSAGE
$TPLMSG["CONFIRM_PASSWORD"]="Confirme sua senha";
//SITE MAP
$TPLMSG["SITEMAP"]="Mapa do Site";

//DELIVERY_NOTICE
$TPLMSG['DELIVERY_NOTICE'] = "Aviso de Entrega";
$TPLMSG['DELIVERY_ID'] = "ID fim";
$TPLMSG['DELIVERY_TOTAL_PRICE'] = "Preço de entrega";
$TPLMSG['DELIVERY_DATE'] = "Data de entrega";

//VIRTUAL ACCOUNT
$TPLMSG['TRANSFER_BANK'] = "Transferência Bancária";
$TPLMSG['TRANSFER_BANK_CODE'] = "Nome do banco";
$TPLMSG['TRANSFER_ACCOUNT'] = "Conta de transferência";

$TPLMSG['SELECT_COUNTRY'] = "Wybierz kraj";
...
$TPLMSG['COMPANY_ADDRESS'] = "endereço";
