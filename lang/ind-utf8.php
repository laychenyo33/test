...
$TPLMSG['SEND'] = "Send";
$TPLMSG['REPLY'] = "Reply";
$TPLMSG['REPLY_YES'] = "<font color='blue'>Yes</font>";
$TPLMSG['REPLY_NO'] = "<font color='red'>No</font>";
$TPLMSG['DEL'] = "Del";
$TPLMSG['CATE'] = "Category";
$TPLMSG['YES'] = "Yes";
$TPLMSG['NO'] = "No";
$TPLMSG['DATE_ONLINE'] = "Online Date";
$TPLMSG['CONTACT'] = "Contact Man";
$TPLMSG['URL'] = "URL";
$TPLMSG['OK'] = "OK";
$TPLMSG['CANCEL'] = "Cancel";
$TPLMSG['DATE'] = "Date";
$TPLMSG['TIME'] = "Time";
$TPLMSG['CREATEDATE'] = "Created";
$TPLMSG['MODIFYDATE'] = "Modified";
...
//LOGIN
$TPLMSG['LOGIN_ACCOUNT'] = "Account";
$TPLMSG['LOGIN_PASSWORD'] = "Password";
$TPLMSG['LOGIN_SECURITY'] = "Code";
$TPLMSG['LOGIN_LANGUAGE'] = "Language";
$TPLMSG['LOGIN_NOTICE1'] = "Please login or sign up to download our videos.";
...
//ADMIN
$TPLMSG['ADMIN_VALID_ACCOUNT'] = "Valid Account";
$TPLMSG['ADMIN_ACCOUNT_EXIST'] = "Exist";
$TPLMSG['ADMIN_ACCOUNT_NO_USE'] = "Unregistered";
$TPLMSG['ADMIN_PLEASE_INPUT_ACCOUNT'] = "Please input account.";
//CONTACT US
$TPLMSG['CONTACT_US'] = "Contact Us";
$TPLMSG['CONTACT_US_PRODUCTS'] = "About Products";
...
//MEMBER
$TPLMSG['MEMBER_ZONE']="Member Login";
$TPLMSG['BIRTHDAY']="Birthday";
$TPLMSG['ZIP']="ZIP";
$TPLMSG['SEX']="";
$TPLMSG['MALE']="Male";
$TPLMSG['FEMALE']="Female";
$TPLMSG['ADDRESS']="Address";
$TPLMSG['TEL']="Tel";
$TPLMSG['FAX']="Fax";
$TPLMSG['CONTACT_PERSON']="Contact Person";
...
$TPLMSG["MEMBER_LOGOUT"]="Logout";
$TPLMSG['MEMBER_JOIN']="Register";
$TPLMSG['MEMBER_CONFIRM_MAIL']="Confirm E-mail";
$TPLMSG['MEMBER_NAME']="Name";
$TPLMSG['MEMBER_FNAME']="first name";
$TPLMSG['MEMBER_LNAME']="last name";
$TPLMSG['MEMBER_ZONE_DATA']="Member's Data";
$TPLMSG['MEMBER_ZONE_ORDER']="Member's Orders";
$TPLMSG['MEMBER_ZONE_INQUIRY']="Member's Inquiries";
$TPLMSG['MEMBER_ZONE_CONTACTUS']="Feedback";
$TPLMSG['MEMBER_ZONE_GREETINGS']="Hi, %s";
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="Accept Service Term";
$TPLMSG['MEMBER_DISCOUNT']="Discount";
$TPLMSG['MEMBER_MUTI_TEL_NOTICE']="Separated  by ','";
$TPLMSG['MEMBER_MUTI_FAX_NOTICE']="Separated  by ','";
$TPLMSG['MEMBER_MUTI_CELLPHONE_NOTICE']="Separated  by ','";
$TPLMSG['MEMBER_MUTI_EMAIL_NOTICE']="Separated  by ','";
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="I agree";
...
$TPLMSG['PRODUCT_IMG'] = "Product Image";
$TPLMSG['PRODUCT_CATE'] = "Category";
$TPLMSG['PRODUCT_LIST'] = "Products List";
$TPLMSG['PRODUCT_SHOW'] = "Products Display";
$TPLMSG['PRODUCT_NAME'] = "Product Name";
$TPLMSG['PRODUCT_NEW'] = "New Products";
$TPLMSG['PRODUCT_HOT'] = "Hot Products";
$TPLMSG['PRODUCT_PROMOTION'] = "Promotion Products";
$TPLMSG['PRODUCT_DESCRIPTION'] = "Product Description";
$TPLMSG['PRODUCT_SPEC'] = "Product Specifications";
$TPLMSG['PRODUCT_CHARACTER'] = "Product Feature";
$TPLMSG['PRODUCT_PRICE'] = "Price";
$TPLMSG['PRODUCT_LIST_PRICE'] = "List Price";
$TPLMSG['PRODUCT_SPECIAL_PRICE'] = "On Sale";
$TPLMSG['PRODUCT_DISCOUNT_PRICE'] = "Discount Price";
$TPLMSG['PRODUCT_SERIAL'] = "Product Serial";
$TPLMSG['PRODUCT_COLLECTION'] = "Collect it";
$TPLMSG['PRODUCT_OUT_OF_STOCK'] = "Out of stock.";

// CART
$TPLMSG['CART_ADD'] = "";
$TPLMSG['CART_INQUIRY'] = "Inquiry Cart";
...
$TPLMSG["JOIN_MEMBER_MAIL"] = "Join Member auto-reply email";
$TPLMSG["PAYMENT_TERM"] = "Payment Term";
$TPLMSG["PRIVACY_POLICY"] = "Privacy Policy";
$TPLMSG["SERVICE_TERM"] = "Terms of Service";
$TPLMSG["SHIPPING_TERM"] = "Shipping Term";
$TPLMSG["SHOPPING_TERM"] = "Shopping Term";
$TPLMSG["INQUIRY_MAIL"] = "Inquiry Cart auto-reply email";
...
$TPLMSG["ORDER_NEW"]="New";
$TPLMSG["ORDER_DEALING"]="Dealing";
$TPLMSG["ORDER_PRODUCTS_SEND"]="Prepare";
$TPLMSG["ORDER_COMPLETED"]="Completed";
$TPLMSG["ORDER_CANCEL"]="<font color='red'>Cancel</font>";
$TPLMSG["ORDER_REJECT"]="<font color='red'>Reject</font>";
...
$TPLMSG["INQUIRY_CONTENT"]="Content";
...
//ERROR MESSAGE
$TPLMSG['LOGIN_ERROR'] = "Account or Password Error!!";
$TPLMSG['SECURITY_ERROR'] = "Security Code Error!!";
//DATA MESSAGE
$TPLMSG['NO_DATA'] = "Empty!!";
$TPLMSG['NO_CATE'] = "No Category";
//JS MESSAGE
$TPLMSG["CONFIRM_PASSWORD"]="Confirm Password";
//SITE MAP
$TPLMSG["SITEMAP"]="Sitemap";

//DELIVERY_NOTICE
$TPLMSG['DELIVERY_NOTICE'] = "Delivery Notice";
$TPLMSG['DELIVERY_ID'] = "Order ID";
$TPLMSG['DELIVERY_TOTAL_PRICE'] = "Delivery Price";
$TPLMSG['DELIVERY_DATE'] = "Delivery Date";
...
$TPLMSG['SELECT_COUNTRY'] = "देश चुनें";
