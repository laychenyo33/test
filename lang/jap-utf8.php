...
$TPLMSG['NAME'] = "お名前";
$TPLMSG['JOIN'] = "参加する";
$TPLMSG['INQUIRY'] = "お問い合わせ";
$TPLMSG['INQUIRY_CART'] = "お問い合わせカート";
$TPLMSG['INQUIRY_PRICE'] = "お問い合わせ";
$TPLMSG['SHOPPING'] = "購入する";
$TPLMSG['SHOPPING_CART'] = "ショッピングカート";
$TPLMSG['STATUS'] = "ステータス";
$TPLMSG['ADD'] = "追加";
$TPLMSG['MODIFY'] = "変更";
$TPLMSG['SEND'] = "送信";
$TPLMSG['REPLY'] = "返信";
$TPLMSG['REPLY_YES'] = "<font color='blue'>はい</font>";
$TPLMSG['REPLY_NO'] = "<font color='red'>いいえ</font>";
$TPLMSG['DEL'] = "削除する";
$TPLMSG['CATE'] = "カテゴリー";
$TPLMSG['YES'] = "はい";
$TPLMSG['NO'] = "いいえ";
$TPLMSG['DATE_ONLINE'] = "オンライン日付";
$TPLMSG['CONTACT'] = "お問い合わせマン";
$TPLMSG['URL'] = "ホームページ";
$TPLMSG['OK'] = "良い";
$TPLMSG['CANCEL'] = "キャンセル";
$TPLMSG['DATE'] = "日付";
$TPLMSG['TIME'] = "時間";
$TPLMSG['CREATEDATE'] = "作成";
$TPLMSG['MODIFYDATE'] = "変更";
$TPLMSG['STARTDATE'] = "開始";
$TPLMSG['ENDDATE'] = "有効期限";
$TPLMSG['TOTAL'] = "合計";
$TPLMSG['PAGES'] = "ページ";
$TPLMSG['DELETE_CHECK_STR'] = "あなたはよろしいですか？";
$TPLMSG['TOTAL_RECORDS'] = "レコードの総数";
$TPLMSG['TOTAL_PAGES'] = "総ページ数";
$TPLMSG['AMOUNT'] = "数量";
$TPLMSG['DETAIL'] = "詳細";
$TPLMSG['VIEWS'] = "ビュー";
$TPLMSG['FILE'] = "ファイル";
$TPLMSG['PUBLISH_ON'] = "未経過";
$TPLMSG['PUBLISH_OFF'] = "期限切れの";
$TPLMSG['PAGE_BACK'] = "戻る";
$TPLMSG['EMAIL'] = "E-mail";
$TPLMSG['CLEAN'] = "Clean";
...
//LOGIN
$TPLMSG['LOGIN_ACCOUNT'] = "アカウント";
$TPLMSG['LOGIN_PASSWORD'] = "パスワード";
$TPLMSG['LOGIN_SECURITY'] = "答えを入力";
$TPLMSG['LOGIN_LANGUAGE'] = "言語";
$TPLMSG['LOGIN_NOTICE1'] = "ログインまたは私たちの動画をダウンロードしてサインアップしてください。";
$TPLMSG['LOGIN_FORGOT_PASSWORD'] = "パスワードを忘れた方?";
$TPLMSG['LOGIN_REGISTER'] = "レジスタへ移動";
$TPLMSG["LOGIN_BUTTON"] = "ログイン";
//NEWS
$TPLMSG['NEWS'] = "ニュース";
//FAQ
$TPLMSG['FAQ'] = "よくあるご質問";
//ABOUT US
$TPLMSG['ABOUT_US'] = "会社案内";
//AD
...
//ADMIN
$TPLMSG['ADMIN_VALID_ACCOUNT'] = "有効なアカウント";
$TPLMSG['ADMIN_ACCOUNT_EXIST'] = "存在";
$TPLMSG['ADMIN_ACCOUNT_NO_USE'] = "未登録の";
$TPLMSG['ADMIN_PLEASE_INPUT_ACCOUNT'] = "入力アカウントをしてください。";
//CONTACT US
$TPLMSG['CONTACT_US'] = "お問い合わせ";
$TPLMSG['CONTACT_US_PRODUCTS'] = "製品について";
$TPLMSG['CONTACT_ERROR_REPORTING'] = "エラーフィードバック";
$TPLMSG['CONTACT_SUGGESTION'] = "ご意見";
$TPLMSG['CONTACT_US_OTHERS'] = "その他";
$TPLMSG['CONTACT_US_MAIL_NOTICE'] = "我々は歓迎し、当社の製品およびサービスについてのあなたのフィードバックを大切にしています。我々は、あなたの質問に即座に応答されます。";
$TPLMSG["CONTACT_US_DETAIL"]="詳細";
$TPLMSG["CONTACT_US_REPLY"]="返信";
$TPLMSG["CONTACT_US_REPLY_CONTENT"]="コンテンツ";
$TPLMSG["CONTACT_US_REPLY_TIME"]="返信時間";
$TPLMSG['CONTACT_US_COMPANY_NAME']="会社名";
$TPLMSG['CONTACT_US_TITLE']="タイトル";
$TPLMSG['CONTACT_US_FAX']="ファックス";
$TPLMSG['CONTACT_US_MOBIL']="モバイル";
$TPLMSG['CONTACT_US_SITE']="ウェブサイト";
...
$TPLMSG['EPAPER'] = "電子ペーパー";
//MEMBER
$TPLMSG['MEMBER_ZONE']="メンバーログイン";
$TPLMSG['BIRTHDAY']="誕生日";
$TPLMSG['ZIP']="郵便番号";
$TPLMSG['SEX']="";
$TPLMSG['MALE']="男性";
...
$TPLMSG['TEL']="電話番号";
$TPLMSG['FAX']="ファックス";
$TPLMSG['CONTACT_PERSON']="担当者";
$TPLMSG['COMPANY_NAME']="会社名";
$TPLMSG['CELLPHONE']="携帯電話";
$TPLMSG['COUNTRY']="国";
...
$TPLMSG['MEMBER_CONFIRM_MAIL']="確認メール";
$TPLMSG['MEMBER_NAME']="お名前";
$TPLMSG['MEMBER_FNAME']="first name";
$TPLMSG['MEMBER_LNAME']="last name";
$TPLMSG['MEMBER_ZONE_DATA']="会員のデータ";
$TPLMSG['MEMBER_ZONE_ORDER']="会員の受注";
$TPLMSG['MEMBER_ZONE_INQUIRY']="会員のお問い合わせ";
$TPLMSG['MEMBER_ZONE_CONTACTUS']="フィードバック";
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="受け入れサービスの用語";
$TPLMSG['MEMBER_DISCOUNT']="割引";
$TPLMSG['MEMBER_MUTI_TEL_NOTICE']="区切りで ','";
$TPLMSG['MEMBER_MUTI_FAX_NOTICE']="区切りで  by ','";
$TPLMSG['MEMBER_MUTI_CELLPHONE_NOTICE']="区切りで  by ','";
$TPLMSG['MEMBER_MUTI_EMAIL_NOTICE']="区切りで  by ','";
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="私は同意";
...
$TPLMSG["MEMBER_ACCOUNT_EXISTS"] = "メンバーアカウントが存在していました！";
...
$TPLMSG['PRODUCT'] = "製品";
$TPLMSG['PRODUCT_IMG'] = "製品画像";
$TPLMSG['PRODUCT_CATE'] = "カテゴリー";
$TPLMSG['PRODUCT_LIST'] = "製品一覧";
$TPLMSG['PRODUCT_SHOW'] = "製品表示";
$TPLMSG['PRODUCT_NAME'] = "製品名";
$TPLMSG['PRODUCT_NEW'] = "新製品";
$TPLMSG['PRODUCT_HOT'] = "人気製品";
$TPLMSG['PRODUCT_PROMOTION'] = "プロモーション製品";
$TPLMSG['PRODUCT_DESCRIPTION'] = "概要";
$TPLMSG['PRODUCT_SPEC'] = "仕様";
$TPLMSG['PRODUCT_CHARACTER'] = "キャラクター";
$TPLMSG['PRODUCT_PRICE'] = "価格";
$TPLMSG['PRODUCT_LIST_PRICE'] = "価格";
...
// CART
$TPLMSG['CART_ADD'] = "";
$TPLMSG['CART_INQUIRY'] = "お問い合わせカートに入れる";
$TPLMSG['CART_SHOPPING'] = "ショッピングカート";
$TPLMSG['CART_TOTAL'] = "合計";
$TPLMSG['CART_SUBTOTAL'] = "小計";
$TPLMSG['CART_AMOUNT'] = "数量";
$TPLMSG['CART_MODIFY_AMOUNT'] = "数量変更";
$TPLMSG['CART_CONTINUE_SHOPPING'] = "元の商品ページに戻る";
$TPLMSG['CART_CONTINUE_INQUIRY'] = "元の商品ページに戻る";
...
$TPLMSG["JOIN_MEMBER_MAIL"] = "会員自動返信メールに参加する";
$TPLMSG["PAYMENT_TERM"] = "支払の条件";
$TPLMSG["PRIVACY_POLICY"] = "プライバシーポリシー";
$TPLMSG["SERVICE_TERM"] = "サービスの条件";
$TPLMSG["SHIPPING_TERM"] = "発送条件";
$TPLMSG["SHOPPING_TERM"] = "ショッピング用語";
$TPLMSG["INQUIRY_MAIL"] = "お問い合わせカートの自動返信メール";
...
$TPLMSG["ORDER_TOTAL_MONEY"]="合計";
$TPLMSG["ORDER_NEW"]="新";
$TPLMSG["ORDER_DEALING"]="ディーリング";
$TPLMSG["ORDER_PRODUCTS_SEND"]="準備";
$TPLMSG["ORDER_COMPLETED"]="完了";
$TPLMSG["ORDER_CANCEL"]="<font color='red'>キャンセル</font>";
$TPLMSG["ORDER_REJECT"]="<font color='red'>拒否</font>";
$TPLMSG["ORDER_DETAIL"]="詳細";
$TPLMSG["ORDER_CONTENT"]="コンテンツ";
...
//PAYMENT
$TPLMSG["PAYMENT_TYPE"]="支払いタイプ";
$TPLMSG["PAYMENT_ATM"]="ATMの";
$TPLMSG["PAYMENT_CASH_ON_DELIVERY"]="着払い";
$TPLMSG['CHOOSE_PAYMENT_TYPE'] = "choose a type";

//INQUIRY
$TPLMSG["INQUIRY_ID"]="お問い合わせ番号";
$TPLMSG["INQUIRY_DETAIL"]="詳細";
$TPLMSG["INQUIRY_CONTENT"]="コンテンツ";
$TPLMSG["INQUIRY_QUANTITY_UPDATED"]="Quantity updated!";

//DOWNLOAD
$TPLMSG["DOWNLOAD"]="ダウンロード";

//FORGOT PASSWORD
$TPLMSG["FORGOT_PASSWORD"]="パスワードを忘れた";

//EBOOK
$TPLMSG["EBOOK"]="電子カタログ";
$TPLMSG["EBOOK_DOWNLOAD"]="Download";
$TPLMSG["EBOOK_PRINT"] ="印刷";

//ACTION MESSAGE
$TPLMSG['ACTION_TERM'] = "ちょっと待って!!<BR>このページはリダイレクトされます!!";
$TPLMSG['ACTION_TERM_JS'] = "あなたのデータが提出されている!!";
$TPLMSG["ACCOUNT_EXIST"] ="このアカウントは存在していた!入力してください新しいアカウント!";


//ERROR MESSAGE
$TPLMSG['LOGIN_ERROR'] = "アカウントまたはパスワードのエラー!!";
$TPLMSG['SECURITY_ERROR'] = "セキュリティ コード エラー!!";
//DATA MESSAGE
$TPLMSG['NO_DATA'] = "空!!";
$TPLMSG['NO_CATE'] = "カテゴリなし";
//JS MESSAGE
$TPLMSG["CONFIRM_PASSWORD"]="パスワードを確認";
//SITE MAP
$TPLMSG["SITEMAP"]="サイトマップ";

//DELIVERY_NOTICE
$TPLMSG['DELIVERY_NOTICE'] = "配信通知";
$TPLMSG['DELIVERY_ID'] = "注文ID";
$TPLMSG['DELIVERY_TOTAL_PRICE'] = "配信価格";
$TPLMSG['DELIVERY_DATE'] = "配信日";
