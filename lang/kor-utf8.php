...
$TPLMSG['JOIN'] = "회원 가입";
$TPLMSG['INQUIRY'] = "문의";
$TPLMSG['INQUIRY_CART'] = "문의 장바구니";
$TPLMSG['INQUIRY_PRICE'] = "문의";
$TPLMSG['SHOPPING'] = "구매";
$TPLMSG['SHOPPING_CART'] = "장바구니";
$TPLMSG['STATUS'] = "지위";
$TPLMSG['ADD'] = "추가";
$TPLMSG['MODIFY'] = "수정할";
$TPLMSG['SEND'] = "보내기";
$TPLMSG['REPLY'] = "대답";
$TPLMSG['REPLY_YES'] = "<font color='blue'>예</font>";
$TPLMSG['REPLY_NO'] = "<font color='red'>아니</font>";
$TPLMSG['DEL'] = "삭제";
$TPLMSG['CATE'] = "범주";
$TPLMSG['YES'] = "예";
$TPLMSG['NO'] = "아니";
$TPLMSG['DATE_ONLINE'] = "온라인 날짜";
$TPLMSG['CONTACT'] = "접촉";
$TPLMSG['URL'] = "웹사이트";
$TPLMSG['OK'] = "결정";
$TPLMSG['CANCEL'] = "취소";
$TPLMSG['DATE'] = "날짜";
$TPLMSG['TIME'] = "시간";
$TPLMSG['CREATEDATE'] = "작성 일자";
$TPLMSG['MODIFYDATE'] = "수정 일자";
$TPLMSG['STARTDATE'] = "시작일 일자";
$TPLMSG['ENDDATE'] = "만료";
$TPLMSG['TOTAL'] = "합계";
$TPLMSG['PAGES'] = "페이지";
$TPLMSG['DELETE_CHECK_STR'] = "계속하시겠습니까?";
$TPLMSG['TOTAL_RECORDS'] = "총 항목";
$TPLMSG['TOTAL_PAGES'] = "총 페이지";
$TPLMSG['AMOUNT'] = "양";
$TPLMSG['DETAIL'] = "상세";
$TPLMSG['VIEWS'] = "전망";
$TPLMSG['FILE'] = "파일";
$TPLMSG['PUBLISH_ON'] = "만료되지는 않은";
...
//LOGIN
$TPLMSG['LOGIN_ACCOUNT'] = "계정";
$TPLMSG['LOGIN_PASSWORD'] = "암호";
$TPLMSG['LOGIN_SECURITY'] = "확인 코드";
$TPLMSG['LOGIN_LANGUAGE'] = "언어";
$TPLMSG['LOGIN_NOTICE1'] = "로그인 또는 동영상을 다운로드 가입하시기 바랍니다.";
$TPLMSG['LOGIN_FORGOT_PASSWORD'] = "비밀 번호를 잊으셨습니까?";
$TPLMSG['LOGIN_REGISTER'] = "회원 가입";
$TPLMSG["LOGIN_BUTTON"] = "로그인";
//NEWS
$TPLMSG['NEWS'] = "최신소식";
//FAQ
$TPLMSG['FAQ'] = "FAQ";
//ABOUT US
$TPLMSG['ABOUT_US'] = "회사소개";
//AD
...
//ADMIN
$TPLMSG['ADMIN_VALID_ACCOUNT'] = "당좌 계좌를";
$TPLMSG['ADMIN_ACCOUNT_EXIST'] = "계정 반복";
$TPLMSG['ADMIN_ACCOUNT_NO_USE'] = "등록되지 않은";
$TPLMSG['ADMIN_PLEASE_INPUT_ACCOUNT'] = "입력 계정을하시기 바랍니다.";
//CONTACT US
$TPLMSG['CONTACT_US'] = "연락하기";
$TPLMSG['CONTACT_US_PRODUCTS'] = "제품";
$TPLMSG['CONTACT_ERROR_REPORTING'] = "오류";
$TPLMSG['CONTACT_SUGGESTION'] = "암시";
$TPLMSG['CONTACT_US_OTHERS'] = "기타";
$TPLMSG['CONTACT_US_MAIL_NOTICE'] = "제안 주셔서 감사합니다, 우리는 최대한 빨리 회신해 드리겠습니다.";
$TPLMSG["CONTACT_US_DETAIL"]="상세";
$TPLMSG["CONTACT_US_REPLY"]="대답";
$TPLMSG["CONTACT_US_REPLY_CONTENT"]="내용";
$TPLMSG["CONTACT_US_REPLY_TIME"]="응답 시간";
$TPLMSG['CONTACT_US_COMPANY_NAME']="회사명";
$TPLMSG['CONTACT_US_TITLE']="제목";
$TPLMSG['CONTACT_US_FAX']="팩스";
$TPLMSG['CONTACT_US_MOBIL']="휴대 전화 번호";
$TPLMSG['CONTACT_US_SITE']="웹사이트";
...
$TPLMSG['TEL']="전화 번호";
$TPLMSG['FAX']="팩스";
$TPLMSG['CONTACT_PERSON']="담당자 이름";
$TPLMSG['COMPANY_NAME']="회사명";
$TPLMSG['CELLPHONE']="휴대 전화 번호";
$TPLMSG['COUNTRY']="국가";
...
$TPLMSG['MEMBER_CONFIRM_MAIL']="이메일 확인";
$TPLMSG['MEMBER_NAME']="이름";
$TPLMSG['MEMBER_FNAME']="first name";
$TPLMSG['MEMBER_LNAME']="last name";
$TPLMSG['MEMBER_ZONE_DATA']="회원 데이터 관리";
...
$TPLMSG['MEMBER_MUTI_FAX_NOTICE']="','로 구분";
$TPLMSG['MEMBER_MUTI_CELLPHONE_NOTICE']="','로 구분";
$TPLMSG['MEMBER_MUTI_EMAIL_NOTICE']="','로 구분";
$TPLMSG['MEMBER_ACCEPT_SERVICE_TERM']="약관에 동의";
...
$TPLMSG['PRODUCT'] = "제품소개";
$TPLMSG['PRODUCT_IMG'] = "제품 이미지";
$TPLMSG['PRODUCT_CATE'] = "범주";
$TPLMSG['PRODUCT_LIST'] = "제품리스트";
$TPLMSG['PRODUCT_SHOW'] = "제품 표시";
$TPLMSG['PRODUCT_NAME'] = "제품 이름";
$TPLMSG['PRODUCT_NEW'] = "신상품";
$TPLMSG['PRODUCT_HOT'] = "핫 제품";
$TPLMSG['PRODUCT_PROMOTION'] = "프로모션 제품";
$TPLMSG['PRODUCT_DESCRIPTION'] = "제품 설명";
$TPLMSG['PRODUCT_SPEC'] = "제품 사양";
$TPLMSG['PRODUCT_CHARACTER'] = "제품 특징";
$TPLMSG['PRODUCT_PRICE'] = "가격";
$TPLMSG['PRODUCT_LIST_PRICE'] = "가격";
...
// CART
$TPLMSG['CART_ADD'] = "";
$TPLMSG['CART_INQUIRY'] = "문의 장바구니";
$TPLMSG['CART_SHOPPING'] = "장바구니";
$TPLMSG['CART_TOTAL'] = "합계";
$TPLMSG['CART_SUBTOTAL'] = "소계";
$TPLMSG['CART_AMOUNT'] = "양";
$TPLMSG['CART_MODIFY_AMOUNT'] = "금액 수정";
$TPLMSG['CART_CONTINUE_SHOPPING'] = "계속";
$TPLMSG['CART_CONTINUE_INQUIRY'] = "계속";
...
$TPLMSG["JOIN_MEMBER_MAIL"] = "회원 자동 회신 이메일 가입";
$TPLMSG["PAYMENT_TERM"] = "지불 방법";
$TPLMSG["PRIVACY_POLICY"] = "개인 정보 보호 정책";
$TPLMSG["SERVICE_TERM"] = "서비스 회원 약관";
$TPLMSG["SHIPPING_TERM"] = "배송 안내";
$TPLMSG["SHOPPING_TERM"] = "쇼핑 안내";
$TPLMSG["INQUIRY_MAIL"] = "문의 장바구니  자동 응답 이메일";
...
$TPLMSG["ORDER_TOTAL_MONEY"]="합계";
$TPLMSG["ORDER_NEW"]="새로운";
$TPLMSG["ORDER_DEALING"]="취급";
$TPLMSG["ORDER_PRODUCTS_SEND"]="준비";
$TPLMSG["ORDER_COMPLETED"]="완료";
$TPLMSG["ORDER_CANCEL"]="<font color='red'>취소</font>";
...
$TPLMSG["PAYMENT_CASH_ON_DELIVERY"]="배달 현금";
$TPLMSG['CHOOSE_PAYMENT_TYPE'] = "choose a type";

//INQUIRY
$TPLMSG["INQUIRY_ID"]="문의 편지 번호";
$TPLMSG["INQUIRY_DETAIL"]="상세";
$TPLMSG["INQUIRY_CONTENT"]="내용";
$TPLMSG["INQUIRY_QUANTITY_UPDATED"]="Quantity updated!";

//DOWNLOAD
$TPLMSG["DOWNLOAD"]="다운로드";

//FORGOT PASSWORD
$TPLMSG["FORGOT_PASSWORD"]="비밀 번호를 잊으셨습니까";

//EBOOK
$TPLMSG["EBOOK"]="E-목록";
$TPLMSG["EBOOK_DOWNLOAD"]="Download";
$TPLMSG["EBOOK_PRINT"] ="인쇄";

//ACTION MESSAGE
$TPLMSG['ACTION_TERM'] = "잠시! <BR>이 페이지는 경로가 변경됩니다!";
$TPLMSG['ACTION_TERM_JS'] = "귀하의 데이터가 제출되었습니다!";
$TPLMSG["ACCOUNT_EXIST"] ="계정 반복";


//ERROR MESSAGE
$TPLMSG['LOGIN_ERROR'] = "계정 또는 비밀 번호 오류!";
$TPLMSG['SECURITY_ERROR'] = "보안 코드 오류!";
//DATA MESSAGE
$TPLMSG['NO_DATA'] = "비우기!";
$TPLMSG['NO_CATE'] = "없음 분류 없음";
//JS MESSAGE
$TPLMSG["CONFIRM_PASSWORD"]="비밀 번호 확인";
//SITE MAP
$TPLMSG["SITEMAP"]="사이트맵";

//DELIVERY_NOTICE
$TPLMSG['DELIVERY_NOTICE'] = "출하 통지";
$TPLMSG['DELIVERY_ID'] = "주문 번호";
$TPLMSG['DELIVERY_TOTAL_PRICE'] = "합계";
$TPLMSG['DELIVERY_DATE'] = "납기 날짜";
