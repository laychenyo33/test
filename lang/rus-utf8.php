...
$TPLMSG['FORM'] = "Форма";
$TPLMSG['SUBJECT'] = "Тема";
$TPLMSG['CONTENT'] = "Содержание";
$TPLMSG['NAME'] = "Название";
$TPLMSG['JOIN'] = "Регистрация";
$TPLMSG['INQUIRY'] = "Запрос";
$TPLMSG['INQUIRY_CART'] = "Запрос корзину";
$TPLMSG['INQUIRY_PRICE'] = "Запрос";
$TPLMSG['SHOPPING'] = "Купить";
$TPLMSG['SHOPPING_CART'] = "Корзина";
$TPLMSG['STATUS'] = "Статус";
$TPLMSG['ADD'] = "Добавить";
$TPLMSG['MODIFY'] = "моделирование";
$TPLMSG['SEND'] = "Отправить";
$TPLMSG['REPLY'] = "Ответить";
$TPLMSG['REPLY_YES'] = "<font color='blue'>Да</font>";
$TPLMSG['REPLY_NO'] = "<font color='red'>Нет</font>";
$TPLMSG['DEL'] = "Del";
$TPLMSG['CATE'] = "Категория";
$TPLMSG['YES'] = "Да";
$TPLMSG['NO'] = "Нет";
$TPLMSG['DATE_ONLINE'] = "Дата Интернет";
$TPLMSG['CONTACT'] = "Контакт человек";
$TPLMSG['URL'] = "URL";
$TPLMSG['OK'] = "OK";
$TPLMSG['CANCEL'] = "Отмена";
$TPLMSG['DATE'] = "Дата";
$TPLMSG['TIME'] = "Время";
$TPLMSG['CREATEDATE'] = "Создано";
$TPLMSG['MODIFYDATE'] = "Изменен";
$TPLMSG['STARTDATE'] = "Пуск";
$TPLMSG['ENDDATE'] = "Срок действия";
$TPLMSG['TOTAL'] = "Всего";
$TPLMSG['PAGES'] = "страницы";
$TPLMSG['DELETE_CHECK_STR'] = "Вы уверены?";
$TPLMSG['TOTAL_RECORDS'] = "Всего записей";
$TPLMSG['TOTAL_PAGES'] = "Всего страниц";
$TPLMSG['AMOUNT'] = "Сумма";
$TPLMSG['DETAIL'] = "Подробнее";
$TPLMSG['VIEWS'] = "Открыть";
$TPLMSG['FILE'] = "Файл";
...
//LOGIN
$TPLMSG['LOGIN_ACCOUNT'] = "Учетная запись";
$TPLMSG['LOGIN_PASSWORD'] = "Пароль";
...
//ADMIN
$TPLMSG['ADMIN_VALID_ACCOUNT'] = "Действительно счет";
$TPLMSG['ADMIN_ACCOUNT_EXIST'] = "существует";
$TPLMSG['ADMIN_ACCOUNT_NO_USE'] = "Незарегистрированная";
$TPLMSG['ADMIN_PLEASE_INPUT_ACCOUNT'] = "Пожалуйста, введите учетную запись.";
//CONTACT US
$TPLMSG['CONTACT_US'] = "Контакты";
$TPLMSG['CONTACT_US_PRODUCTS'] = "О продукции";
$TPLMSG['CONTACT_ERROR_REPORTING'] = "Ошибка Обратная связь";
$TPLMSG['CONTACT_SUGGESTION'] = "Совет";
$TPLMSG['CONTACT_US_OTHERS'] = "другие";
$TPLMSG['CONTACT_US_MAIL_NOTICE'] = "Мы приветствуем и ценим ваши отзывы о нашей продукции и услуг Мы будет ответ на ваш вопрос прямо сейчас.";
$TPLMSG["CONTACT_US_DETAIL"]="Подробнее";
...
//MEMBER
$TPLMSG['MEMBER_ZONE']="Вход для зарегистрированных пользователей";
$TPLMSG['BIRTHDAY']="День рождения";
$TPLMSG['ZIP']="ZIP";
$TPLMSG['SEX']="";
$TPLMSG['MALE']="Мужской";
$TPLMSG['FEMALE']="женский";
$TPLMSG['ADDRESS']="Адрес";
$TPLMSG['TEL']="тел";
$TPLMSG['FAX']="Факс";
$TPLMSG['CONTACT_PERSON']="Контактное лицо";
$TPLMSG['COMPANY_NAME']="Название компании";
$TPLMSG['CELLPHONE']="Мобильный телефон";
$TPLMSG['COUNTRY']="страна";
$TPLMSG['MEMBER_CHECK_ACCOUNT']="Действительно счет";
$TPLMSG['MEMBER_CHECK_PASSWORD']="Неверный пароль";
$TPLMSG['MEMBER_DATA_MOD']="Изменить Основные данные";
$TPLMSG['MEMBER_ACCOUNT_NOT_EXISTS']="Account not exists!!";
$TPLMSG['MEMBER_LOGIN']="Войти";
$TPLMSG["MEMBER_LOGOUT"]="Выход";
$TPLMSG['MEMBER_JOIN']="Регистрация";
$TPLMSG['MEMBER_CONFIRM_MAIL']="Подтвердите E-mail";
$TPLMSG['MEMBER_NAME']="Название";
$TPLMSG['MEMBER_FNAME']="first name";
$TPLMSG['MEMBER_LNAME']="last name";
$TPLMSG['MEMBER_ZONE_DATA']="члена данных";
...
$TPLMSG['MEMBER_MUTI_FAX_NOTICE']="Разделенные ','";
...
$TPLMSG["MEMBER_ACCOUNT_EXISTS"] = "На сайте существует!";
...
$TPLMSG['PRODUCT_IMG'] = "Изображение продукта";
$TPLMSG['PRODUCT_CATE'] = "Категория";
$TPLMSG['PRODUCT_LIST'] = "Список продуктов";
$TPLMSG['PRODUCT_SHOW'] = "Продукты Дисплей";
$TPLMSG['PRODUCT_NAME'] = "Название";
$TPLMSG['PRODUCT_NEW'] = "Новые продукты";
$TPLMSG['PRODUCT_HOT'] = "Новые продукты";
$TPLMSG['PRODUCT_PROMOTION'] = "Рекламная продукция";
$TPLMSG['PRODUCT_DESCRIPTION'] = "Описание продукции";
$TPLMSG['PRODUCT_SPEC'] = "Технические характеристики";
$TPLMSG['PRODUCT_CHARACTER'] = "Характер продукта";
$TPLMSG['PRODUCT_PRICE'] = "Цены";
$TPLMSG['PRODUCT_LIST_PRICE'] = "Цены";
$TPLMSG['PRODUCT_SPECIAL_PRICE'] = "на продажу";
$TPLMSG['PRODUCT_DISCOUNT_PRICE'] = "со скидкой";
$TPLMSG['PRODUCT_SERIAL'] = "No модели";
$TPLMSG['PRODUCT_COLLECTION'] = "Collect it";
$TPLMSG['PRODUCT_OUT_OF_STOCK'] = "Out of stock.";

// CART
$TPLMSG['CART_ADD'] = "";
$TPLMSG['CART_INQUIRY'] = "Запрос корзину";
$TPLMSG['CART_SHOPPING'] = "Корзина";
$TPLMSG['CART_TOTAL'] = "Всего";
$TPLMSG['CART_SUBTOTAL'] = "Итого";
$TPLMSG['CART_AMOUNT'] = "Сумма";
$TPLMSG['CART_MODIFY_AMOUNT'] = "Изменить Сумма";
$TPLMSG['CART_CONTINUE_SHOPPING'] = "Продолжить";
$TPLMSG['CART_CONTINUE_INQUIRY'] = "Продолжить";
...
$TPLMSG["CONTACTUS_TERM"] = "Контакты срок";
$TPLMSG["JOIN_MEMBER_MAIL"] = "Присоединиться к членам автоответчика электронной почты";
$TPLMSG["PAYMENT_TERM"] = "Термин компенсации";
$TPLMSG["PRIVACY_POLICY"] = "Конфиденциальность и безопасность";
$TPLMSG["SERVICE_TERM"] = "Условия предоставления услуг";
$TPLMSG["SHIPPING_TERM"] = "Срок доставки";
$TPLMSG["SHOPPING_TERM"] = "Шоппинг срок";
$TPLMSG["INQUIRY_MAIL"] = "Запрос корзину автоответчика электронной почты";
...
$TPLMSG["ORDER_TOTAL_MONEY"]="Всего";
$TPLMSG["ORDER_NEW"]="Новый";
$TPLMSG["ORDER_DEALING"]="Преодоление";
$TPLMSG["ORDER_PRODUCTS_SEND"]="Подготовка";
$TPLMSG["ORDER_COMPLETED"]="Завершено";
$TPLMSG["ORDER_CANCEL"]="<font color='red'>Отмена</font>";
$TPLMSG["ORDER_REJECT"]="<font color='red'>Отклонить</font>";
$TPLMSG["ORDER_DETAIL"]="Подробнее";
$TPLMSG["ORDER_CONTENT"]="Содержание";
...
$TPLMSG["PAYMENT_CASH_ON_DELIVERY"]="Денежные средства доставки";
...
$TPLMSG["EBOOK_PRINT"] ="печать";

//ACTION MESSAGE
$TPLMSG['ACTION_TERM'] = "Просто момент <BR> Эта страница будет перенаправлен!";
$TPLMSG['ACTION_TERM_JS'] = "Ваши данные были представлены!";
$TPLMSG["ACCOUNT_EXIST"] ="Это accout является существовали Пожалуйста, введите новую учетную запись!";


//ERROR MESSAGE
$TPLMSG['LOGIN_ERROR'] = "учетной записи или пароля Ошибка!";
$TPLMSG['SECURITY_ERROR'] = "Безопасность код ошибки!";
//DATA MESSAGE
$TPLMSG['NO_DATA'] = "Очистить!";
$TPLMSG['NO_CATE'] = "Нет категории";
//JS MESSAGE
$TPLMSG["CONFIRM_PASSWORD"]="Подтверждение пароля";
//SITE MAP
$TPLMSG["SITEMAP"]="Карта сайта";

//DELIVERY_NOTICE
$TPLMSG['DELIVERY_NOTICE'] = "Уведомление о доставке";
$TPLMSG['DELIVERY_ID'] = "Код заказа";
$TPLMSG['DELIVERY_TOTAL_PRICE'] = "Стоимость доставки";
$TPLMSG['DELIVERY_DATE'] = "Дата поставки";

//VIRTUAL ACCOUNT
$TPLMSG['TRANSFER_BANK'] = "Передача Банк";
$TPLMSG['TRANSFER_BANK_CODE'] = "Название банка";
$TPLMSG['TRANSFER_ACCOUNT'] = "Передача счет";

$TPLMSG['SELECT_COUNTRY'] = "Выберите страну";
