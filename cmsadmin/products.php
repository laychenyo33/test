        ...
        switch ($_REQUEST["action_mode"]){
            ...
            case "mod":
                ...
                UPDATE ".$cms_cfg['tb_prefix']."_products SET
                    ...
                    p_spec = '".$_REQUEST["p_spec"]."',
                    p_character_title = '".$_REQUEST["p_character_title"]."',
                    p_character = '".$_REQUEST["p_character"]."',
