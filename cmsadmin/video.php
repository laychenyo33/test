...
class VIDEO{
    ...
    function video_list(){
        ...
        //Youtube影片列表
        $sql="select * from ".$cms_cfg['tb_prefix']."_video  where v_id > '0'";
        //附加條件
        $and_str="";
        if($_REQUEST["st"]=="all"){
        ...
        $page=$main->pagination($cms_cfg["op_limit"],$cms_cfg["jp_limit"],$_REQUEST["nowp"],$_REQUEST["jp"],$fumc_str,$total_records);
        //重新組合包含limit的sql語法
