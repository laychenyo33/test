        ...
        if($action_mode=="mod" && !empty($_REQUEST["n_id"])){
            ...
            if ($rsnum > 0) {
                $tpl->assignGlobal( array("NOW_N_ID"  => $row["n_id"],
                                          ...
                                          "VALUE_N_URL" => $main->content_file_str_replace($row["n_url"],'out'),
            ...
            case "add":
                $sql="
                    insert into ".$cms_cfg['tb_prefix']."_news (
                        ...
                        '".$main->content_file_str_replace($_REQUEST["n_url"],'in')."',
            ...
            case "mod":
                $sql="
                    update ".$cms_cfg['tb_prefix']."_news set
                        ...
                        n_url='".$main->content_file_str_replace($_REQUEST["n_url"],'in')."',
