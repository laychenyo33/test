<?php
	// 主要設定 ----
	$this->allpay_switch = true; // 於 cart class 使用歐付寶功能, true => 開啟 , false => 單獨使用歐付寶
	$this->anonymous_switch = true; // 匿名產品名稱, true => 開啟 , false => 關閉
...
//	$this->all_cfg["POST"] = "https://payment.allpay.com.tw"; // 串接主機 (正式)
	...
	$this->all_cfg["PaymentInfoURL"] = $cms_cfg['base_url']."shopping-result3.php"; // ATM or CVS(超商) 付費專屬資訊回傳網址
