        ...
        $replace_option = array(
            'in' => array(
                'pattern' => array(
                    ...
                    '%(https://'.$cms_cfg['server_name'].')('.$cms_cfg['file_root'].')([^\s"><]+\.(html|htm|php|png|gif|jpg|jpeg))%i',
                    ...
                    '%((http://)*'.$cms_cfg['server_name'].')('.$cms_cfg['file_root'].')([^\s"><]+\.(html|htm|php|png|gif|jpg|jpeg))%i',
