...
$cms_cfg['idx_rand_prod_img_width']="78"; //首頁隨機產品縮圖圖框限制--寬
$cms_cfg['idx_rand_prod_img_height']="55";//首頁隨機產品縮圖圖框限制--高
...
$cms_cfg['epaper_prod_img_width']="110";//購物車小圖圖框限制--寬
$cms_cfg['epaper_prod_img_height']="110";//購物車小圖圖框限制--高
$cms_cfg['ebook_cate_img_width']="180";//電子型錄左選單分類小圖圖框限制--寬
$cms_cfg['ebook_cate_img_height']="212";//電子型錄左選單分類小圖圖框限制--高
