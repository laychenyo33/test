<?php
	...
	$mcFileManagerConfig['general.language'] = "zh"; // en, sv
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,doc,docx,xls,xlsx,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,wmv,asf,flv";
	...
	// Upload options
	$mcFileManagerConfig['upload.maxsize'] = "30MB";
    ...
    $mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,doc,docx,xls,xlsx,asf,flv,wmv,mp3,swf,dcr,mov,qt";
    ...
    $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,doc,docx,xls,xlsx,wmv,mp3,swf,dcr,mov,qt";
	...
	$mcFileManagerConfig['ExternalAuthenticator.external_auth_url'] = "auth_example.php";
