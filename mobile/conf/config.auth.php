...
$cms_cfg['ws_activate_mobile'] = 1; //啟用手機版，0:關閉, 1:啟用
$cms_cfg['ws_ismobile'] = 1;  //執行系統為手機版，0:否, 1:是
...
/*      BASIC(IPB&IPS) SETUP        */
        ...
        "ws_contactus_mail_title_mapto" =>"jap",  //聯絡我們通知信標題對應語系，留空不使用對應文字，以lang/eng-utf8.php為例，填入eng即可使用
        "ws_comment"           =>1,    //評論管理
        "ws_download"          =>0,    //檔案下載
        ...
        "ws_news"=>1,               //最新消息
        "ws_news_unique_cate"=>1,   //最新消息獨立類別，類似au_cate，將特定news類別集合為獨立頁面
...
/*      MEMBER SETUP                   */
        ...
        "ws_cart_login"=>1,             //購物車或詢價車是否需要會員登入
//        'ws_shopping_cart_module' => 'cart+allpay.index',  //購物車功能模組，留空使用預設值，以+組合字串，+前是購物車模組資料夾，+後是使用的類別路徑
        ...
        "ws_new_product_login"=>1,      //最新產品是否需要會員登入
...
/*      OTHER SETUP                 */
        ...
        "ws_seo"=>0,                //0=>取消rewrite , 1=>啟用rewrite
        "ws_version"=>"ipb",        //系統版本:IPS,IPB,IPC
