...
(function($) {
    ...
    if($.validationEngineLanguage){             // IS THERE A LANGUAGE LOCALISATION ?
        ...
        allRules =  {"required":{               // Add your regex rules here, you can take telephone as an example
                        "regex":"none",
                        "alertText":"* Dieses Feld ist obligatorisch",
                    ...
                    "maxCheckbox":{
                        "regex":"none",
                        "alertText":"* Überprüft erlaubt überschritten"},   
                    "minCheckbox":{
                        "regex":"none",
                    ...
                    "confirm":{
                        "regex":"none",
                        "alertText":"* Ihr Feld ist nicht passend"},        
                    "telephone":{
                        "regex":"/^([0-9\-\(\)\ ]+)*$/",
                    ...
                    "date":{
                         ...
                         "alertText":"* Ungültiges Datum muss in YYYY-MM-DD Format"},
                    "onlyNumber":{
                        "regex":"/^([0-9\ ]+)*$/",
                    ...
                    "ajaxUser":{
                        ...
                        "alertTextLoad":"* Lade, bitte warten",
                        "alertText":"* Dieser Benutzer ist bereits vergeben"},    
                    "ajaxAdmin":{
                        "file":"validateAdmin.php",
                        "alertTextOk":"* Dieser Name steht",   
                        "alertTextLoad":"* Lade, bitte warten",
                        "alertText":"* Dieser Name ist bereits vergeben"},
                    "onlyLetter":{
                        "regex":"/^([a-zA-Z\ \']+)*$/",
                        "alertText":"* Briefe nur"}
                    }   
    }
    settings = $.extend({
        allrules:allRules,                  
