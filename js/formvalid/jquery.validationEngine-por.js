...
(function($) {
    ...
    if($.validationEngineLanguage){             // IS THERE A LANGUAGE LOCALISATION ?
        ...
        allRules =  {"required":{               // Add your regex rules here, you can take telephone as an example
                        ...
                        "alertTextCheckboxe":"* Esta opção é necessária"},
                    "length":{
                        "regex":"none",
                        "alertText":"*entre ",
                        "alertText2":" e ",
                    ...
                    "maxCheckbox":{
                        "regex":"none",
                        "alertText":"* Verifica permitido excedido"},   
                    "minCheckbox":{
                        "regex":"none",
                    ...
                    "confirm":{
                        "regex":"none",
                        "alertText":"* Seu campo não é correspondência"},        
                    "telephone":{
                        "regex":"/^([0-9\-\(\)\ ]+)*$/",
                    ...
                    "date":{
                         ...
                         "alertText":"* Inválido data, deve ser no formato AAAA-MM-DD"},
                    "onlyNumber":{
                        "regex":"/^([0-9\ ]+)*$/",
                        "alertText":"* apenas números"},  
                    "noSpecialCaracters":{
                        "regex":"/^([0-9a-zA-Z]+)*$/",
                        "alertText":"* Sem caracters especiais permitido"},  
                    "ajaxUser":{
                        "file":"validateUser.php",
                        "alertTextOk":"* Este usuário está disponível",   
                        "alertTextLoad":"* Carregando, por favor aguarde",
                        "alertText":"* Este usuário já está tomada"},    
                    "ajaxAdmin":{
                        "file":"validateAdmin.php",
                        "alertTextOk":"* This name is available",   
                        "alertTextLoad":"* Carregando, por favor aguarde",
                        "alertText":"* Este nome já está tomada"},
                    "onlyLetter":{
                        "regex":"/^([a-zA-Z\ \']+)*$/",
